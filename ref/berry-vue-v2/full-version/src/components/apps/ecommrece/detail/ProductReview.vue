...
<template>
  <v-row class="mt-2">
    <v-col md="4" sm="6" cols="12" class="align-streach">
      <v-card variant="outlined" elevation="0" class="text-center h-100 d-flex align-center justify-center">
        <div class="pa-4">
          <h4>Average Rating</h4>
          <h2 class="text-primary text-display-large my-4">4.5/5</h2>
          <div class="text-medium-emphasis align-center justify-center d-flex mb-3 ga-2">
    ...
    <v-col md="4" sm="6" cols="12" class="align-streach justify-center">
    ...
    <v-col md="4" sm="12" cols="12" class="align-streach">
      <v-card variant="outlined" elevation="0" class="d-flex align-center justify-center h-100">
        <div class="pa-4">
          <v-btn variant="outlined" color="primary" size="large" prepend-icon="$messageOutline"> Write a Review</v-btn>
        </div>
      </v-card>
    </v-col>
    <v-col sm="12" cols="12">
      <v-card variant="outlined" :class="['d-flex align-center my-7', i === 0 ? 'mt-0' : '']" v-for="(comment, i) in comments" :key="i">
        <div class="d-flex align-start ga-4 pa-4 w-100">
