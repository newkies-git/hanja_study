...
<template>
  <v-row class="mt-5">
    <v-col cols="12" xl="9" lg="8">
          ...
          <v-col cols="12 " sm="6">
            <div class="py-5 px-4 border rounded-md">
              <v-radio value="free" color="primary" class="label-op-1">
                <template #label>
                  <div>
                    <h5 class="mb-1">Standard Delivery (Free)</h5>
                    <h6 class="text-medium-emphasis">Delivery on Monday 8 Jun</h6>
                  </div>
                </template>
              </v-radio>
            </div>
          ...
          <v-col cols="12 " sm="6">
            <div class="py-5 px-4 border rounded-md">
              <v-radio value="paid" color="primary" class="label-op-1">
                <template #label>
                  <div>
                    <h5 class="mb-1">Fast Delivery ($5.00)</h5>
                    <h6 class="text-medium-emphasis">Delivery on Friday 5 Jun</h6>
                  </div>
                </template>
              </v-radio>
            </div>
      ...
      <v-row :density="mdAndDown ? 'compact' : 'default'">
        <v-col cols="12" lg="6">
          <v-radio-group v-model="payment" class="payment-options" hide-details>
                ...
                <template #label>
                  <div class="d-flex align-center w-100 flex-grow-1">
                    <div>
                      ...
                      <h6 class="text-medium-emphasis text-wrap font-weight-regular">
                ...
                <template #label>
                  <div class="d-flex align-center w-100">
                    <div>
                      ...
                      <h6 class="text-medium-emphasis text-wrap font-weight-regular">We support Mastercard, Visa, Discover and Stripe.</h6>
                    </div>
                    <div class="ms-auto">
                ...
                <template #label>
                  <div class="d-flex align-center w-100">
                    <div>
                      ...
                      <h6 class="text-medium-emphasis text-wrap font-weight-regular">Pay with cash when your order is delivered.</h6>
                    </div>
                    <div class="ms-auto">
        ...
        <v-col cols="12" lg="6">
          <v-card variant="flat" :disabled="payment !== 'credit'">
            <v-card-item class="py-3">
              <div class="d-flex align-center justify-space-between">
                <v-card-title class="text-body-large"> Add New Card </v-card-title>
                ...
                <v-col cols="12" xl="6" lg="12" sm="6">
                  <v-card elevation="0" class="object-card overflow-hidden">
                    <v-card-text class="top-object">
                      ...
                      <h5 class="text-white text-medium-emphasis">**** **** **** 2599</h5>
                      <div class="d-flex align-center justify-space-between mt-3">
                        <div>
                          <span class="text-medium-emphasis text-white text-body-small opacity-50">Expire Date</span>
                          <span class="text-medium-emphasis text-white text-body-small opacity-50 mt-1 d-block">05/24</span>
                        </div>
                        <div>
                          <span class="text-medium-emphasis text-white text-body-small opacity-50">CVV</span>
                          <span class="text-medium-emphasis text-white text-body-small opacity-50 mt-1 d-block">085</span>
                        </div>
                      </div>
                    </v-card-text>
                  </v-card>
                ...
                <v-col cols="12" xl="6" lg="12" sm="6">
                  <v-card elevation="0" class="object-card object-secondary overflow-hidden">
                    <v-card-text class="top-object">
                      ...
                      <h5 class="text-white text-medium-emphasis mt-4">**** **** **** 2599</h5>
                      <div class="d-flex align-center justify-space-between mt-3">
                        <div>
                          <span class="text-medium-emphasis text-white text-body-small opacity-50">Expire Date</span>
                          <span class="text-medium-emphasis text-white text-body-small opacity-50 mt-1 d-block">05/24</span>
      ...
      <v-table class="mb-3">
        <tbody>
          <tr v-for="item in getCart" :key="item.name">
            <td>
              <div class="my-3 ga-2 d-flex align-center">
            ...
            <td class="text-headline-medium text-end">${{ item.salePrice * item.qty }}</td>
          </tr>
        </tbody>
      </v-table>
      <OrderSummaryVue />
