...
const items = [
  ...
  },
  {
    ...
    title: 'Series B',
    value: 30,
    color: 'rgba(var(--v-theme-success), var(--v-medium-opacity))'
  },
  {
    key: 3,
    title: 'Series C',
    value: 15,
    color: 'rgba(var(--v-theme-success), var(--v-low-opacity))'
  },
  {
    key: 4,
    title: 'Series D',
    value: 10,
    color: 'rgba(var(--v-theme-lightsuccess), var(--v-high-opacity))'
  }
];
</script>
<template>
