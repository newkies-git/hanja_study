...
const PinkTheme: ThemeDefinition = {
  dark: false,
  variables: {
    'border-color': '#1e88e5',
    'high-opacity': 1,
...
const SeaGreenTheme: ThemeDefinition = {
  dark: false,
  variables: {
    'border-color': '#1e88e5',
    'high-opacity': 1,
...
const OliveGreenTheme: ThemeDefinition = {
  dark: false,
  variables: {
    'border-color': '#1e88e5',
    'high-opacity': 1,
...
const SpeechBlueTheme: ThemeDefinition = {
  dark: false,
  variables: {
    'border-color': '#1e88e5',
    'high-opacity': 1,
