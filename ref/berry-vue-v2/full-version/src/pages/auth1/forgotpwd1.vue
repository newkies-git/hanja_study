...
import AuthForgotPwd from '@/components/auth/forms/AuthForgotPwd.vue';
                  ...
                  <v-card-text class="pa-9">
                    ...
                    <v-row>
                      <v-col cols="12" md="7" sm="7" class="text-sm-start text-center order-sm-first order-last">
                        <h2 class="text-secondary">Forgot password?</h2>
                        <h4 class="font-weight-medium">Enter credentials to continue</h4>
                      </v-col>
