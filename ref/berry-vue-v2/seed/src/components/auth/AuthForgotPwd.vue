...
<template>
  <h4 class="my-4 mb-8 font-weight-regular text-medium-emphasis">Enter your email address below and we'll send you password reset OTP.</h4>
  ...
  <div class="mt-5 text-end">
    <v-divider />
    <v-btn variant="plain" to="/authentication/login1" class="mt-2 text-capitalize me-n2">Already have an account?</v-btn>
  </div>
</template>
