...
<template>
  ...
  <div class="pa-4">
    <div class="d-flex align-center justify-space-between mb-3">
      <h6 class="text-body-large">
        All Notifications
        <v-chip color="warning" variant="flat" size="small" class="ms-2 text-body-small">01</v-chip>
      </h6>
    ...
    <v-list class="py-0" lines="three">
      ...
      <v-list-item value="4" color="secondary" class="no-spacer">
        ...
        <div class="mt-3 bg-lightsecondary rounded pa-5 d-flex align-center">
          ...
          <span class="ms-2 text-body-large">demo.jpg</span>
        </div>
      </v-list-item>
      <v-divider></v-divider>
