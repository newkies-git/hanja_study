...
| ~~P3~~ | ~~기능~~ | ~~**프로필 메인 화면**~~ | ✅ `ProfileScreen` (`/profile`) 구현, 계정 정보·학습 요약·설정 메뉴 및 드로어 연동 완료 | **완료** |
| ~~P3~~ | ~~기능~~ | ~~**즐겨찾기 UI**~~ | ✅ `HanjaCard` & `HanjaDetailScreen` 별 모양 토글 UI, `ProgressRepository` 계정별 즐겨찾기 연동 완료 | **완료** |
