  ...
  <v-card elevation="0">
    <v-card variant="outlined">
      <v-card-text>
        ...
        <v-card elevation="0" class="bg-lightsecondary mt-5 overflow-hidden">
          <div class="pa-5">
        ...
        <div class="mt-4">
          <PerfectScrollbar :style="{ height: '270px' }" :options="{ suppressScrollX: true }">
            <v-list lines="two" class="py-0">
              <v-list-item v-for="(revenue, i) in revenues" :key="i" :value="revenue" color="secondary" rounded="sm">
                ...
                <div class="d-inline-flex align-center justify-space-between w-100">
                  ...
                  <h5 class="ms-auto text-medium-emphasis font-weight-bold">${{ revenue.price }}</h5>
                </div>
              </v-list-item>
            </v-list>
          </PerfectScrollbar>
