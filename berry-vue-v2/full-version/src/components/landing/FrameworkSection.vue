    ...
    <v-container class="maxWidth">
      <v-row class="justify-center">
        <v-col md="12" cols="12" class="text-center">
          <h2 class="text-sm-display-large my-3" style="line-height: 1.2">Berry is now available in multiple frameworks*</h2>
          <p>
    ...
    <v-container fluid>
      <v-row>
        <v-col cols="12">
          <Carousel
            :wrap-around="true"
            class="framework-carousel pb-12"
            :autoplay="2000"
            :transition="500"
          ...
          >
            <Slide v-for="(slide, i) in slideShow" :key="i">
              <div class="carousel__item">
                <v-card class="bg-containerBg framework-box text-center mb-3" variant="flat">
                  <v-card-item class="py-8">
                    <a :href="slide.link" target="_blank" class="text-darkText text-decoration-none">
