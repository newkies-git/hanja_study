        ...
        <v-row>
              ...
              <v-list two-lines>
                <template v-for="(custom, i) in customs" :key="i">
                  <v-list-item color="secondary" class="py-3">
                    ...
                    <v-list-item-subtitle v-if="custom.profit" class="text-body-small text-success text-high-emphasis">
                      {{ custom.percent }}% Profit
                    </v-list-item-subtitle>
                    <v-list-item-subtitle v-else class="text-body-small text-error text-high-emphasis">
                      {{ custom.percent }}% Loss
                    </v-list-item-subtitle>
                    <template #append>
                      <v-list-item-subtitle class="text-body-large text-high-emphasis me-3"> ${{ custom.price }} </v-list-item-subtitle>
          ...
          <v-col cols="12" md="6">
            <UiChildCard title="Scrollable List">
              <PerfectScrollbar style="max-height: 310px" :options="{ suppressScrollX: true }">
                <v-list>
