      ...
      <UiParentCard title="Radio button">
        ...
        <div>
          <v-form ref="myRadioform">
            ...
            <p v-if="selectedRadioValues.length < 1" class="text-error mt-2">You have to choose one Drink</p>
            <v-btn variant="outlined" class="mt-4" color="primary" @click="submitRadio"> Submit </v-btn>
          </v-form>
        </div>
      </UiParentCard>
    </v-col>
