...
import AuthResetPwd from '@/components/auth/forms/AuthResetPwd.vue';
                  ...
                  <v-card-text class="pa-9">
                    ...
                    <v-row>
                      <v-col cols="12" md="7" sm="7" class="text-sm-start text-center order-sm-first order-last">
                        <h2 class="text-secondary">Reset Password</h2>
                        <h4 class="font-weight-medium">Please choose new password.</h4>
                      </v-col>
