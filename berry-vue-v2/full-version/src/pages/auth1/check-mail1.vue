...
import AuthCheckMail from '@/components/auth/forms/AuthCheckMail.vue';
                  ...
                  <v-card-text class="pa-9">
                    ...
                    <v-row>
                      <v-col cols="12" md="7" sm="7" class="text-sm-start text-center order-sm-first order-last">
                        <h2 class="text-secondary">Check Mail</h2>
                        <h4 class="font-weight-medium">Avoid getting locked out.</h4>
                      </v-col>
