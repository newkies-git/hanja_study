...
class PipelineRunner:
    ...
    def _scrape_naver_targets(
        ...
        # hanja_entities.json → Firestore hanja_extend(2단계)용 소스
        hanja_path = self._output_dir / "hanja_entities.json"
        # stroke_entities.json → Firestore hanja_stroke(3단계)용 데이터 소스
        stroke_path = self._output_dir / "stroke_entities.json"
        # word_entities.json → Firestore hanja_word(4단계)용 데이터 소스
