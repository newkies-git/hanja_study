...
산출물은 **JSON 배열**(객체 문서들): `hanja_entities.json`→관리 웹 **`hanja_extend`**(2단계), `stroke_entities.json`→**`hanja_stroke`**(3단계), `word_entities.json`→**`hanja_word`**(4단계). `hanja_basis`는 별도 CSV.
"""
