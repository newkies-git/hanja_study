													...
													<div class="d-flex align-items-center">
														...
														<div class="flex-fill ps-2">
															<div class="position-relative d-flex align-items-center">
																<input type="text" class="form-control rounded-pill bg-white bg-opacity-15" style="padding-inline-end: 120px;" placeholder="Write a comment...">
