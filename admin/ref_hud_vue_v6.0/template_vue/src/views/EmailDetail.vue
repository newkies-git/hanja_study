								...
								<div class="d-flex">
									...
									<div class="flex-fill ms-3">
										<div class="d-lg-flex align-items-center">
											...
											<div class="fs-12px text-white text-opacity-50 text-lg-end mt-lg-0 mt-3">Nov 27, 2026 <span class="d-none d-lg-inline"><br /></span>at 7.00pm</div>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="mailbox-detail-content">
								...
								<div class="mailbox-detail-attachment">
									<div class="mailbox-attachment">
										<a href="#">
											<div class="document-file">
												<i class="fa fa-file-archive mx-auto"></i>
											</div>
									...
									<div class="mailbox-attachment">
										<a href="#">
											<div class="document-file">
												<i class="fa fa-file-video mx-auto"></i>
											</div>
